...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('template/assets/css/style.css') }}?v={{ filemtime(public_path('template/assets/css/style.css')) }}">
</head>
...
<body>
    ...
    <script src="{{ asset('template/assets/js/script.js') }}?v={{ filemtime(public_path('template/assets/js/script.js')) }}"></script>
    <script>
        // Fallback: ensure loader is hidden even if other scripts fail
